...
public class ComportementTabouCollaboratif extends jade.core.behaviours.CyclicBehaviour{
	...
	public ComportementTabouCollaboratif(Agent a) {
		super(a);
	}
	...
	public void action() {
		...
		switch (step) {
		case 0 : 
			//Execution of the Tabou algorithm with as a start the best solution found before 
